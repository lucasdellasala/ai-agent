...
export const MessageIntentSchema = z.object({
  ...
  details: z.object({
    orderIds: z.array(z.string()).optional().describe('IDs de pedidos relevantes'),
    products: z.array(z.string()).optional().describe('Productos solicitados'),
    reasons: z.array(z.string()).optional().describe('Razones de derivacion o temas fuera de contexto'),
  }),
